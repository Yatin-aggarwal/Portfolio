const Project_Discription= {
   Pixel_Prompt:{
    ...
    WGAN_GP:{
        title:'WGAN GP',
        content:'In this project Wasserstein Gan-GP is used to create anime waifu faces from random noises. Architecture of network is designed according to research paper published by "Ishaan Gulrajani, Faruk Ahmed, Martin Arjovsky, Vincent Dumoulin, Aaron Courville. "',
